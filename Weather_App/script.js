...
const API_KEY = "037869eaeb45470583f170853241409";
...
const getWeatherDetails = async (API_URL) => {
    ...
    try {
        ...
        const weatherIcon = Object.keys(weatherCodes).find((icon) => weatherCodes[icon].includes(weatherCode)) || 'default';
...
// Initial weather requests for India as default city
